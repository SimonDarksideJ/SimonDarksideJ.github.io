...
>
> It is not about taking away the fun tasks, don't want it to code for you, then don't, want to create your own artwork, fine do that.  But do not discount the capabilities of the tools because of preconceptions.
>
...
* MCP servers and their capabilities has increased.
...
(but beware using too many as it has a negative effect)
